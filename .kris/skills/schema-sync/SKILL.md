...
## Integration with Larapass

Since this project uses the larapass library for backend code:

1. **Schema sync can detect drift** between larapass migrations and this repo's database
2. **Generated migrations stay in this repo** - they're project-specific fixes
3. **If drift is due to larapass update**, the generated migration documents the schema evolution
