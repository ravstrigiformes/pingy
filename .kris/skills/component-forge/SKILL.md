...
After creating all files, run the **31-item Quality Checklist** (defined below) against the new component. For each failed item, fix it immediately. Report the final score.
